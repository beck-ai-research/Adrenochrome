...
This document defines the strict operational procedures for AI research agents (SWE 1.5 LLM) focusing on the intersection of Adrenochrome mythologies, Extremist networks (Nazi/Neo-Nazi), Cults, and their activities in Germany (DE), Austria (AT), and Switzerland (CH), as well as global connections.
...
**Focus:** Deconstructing conspiracy theories and tracking the evolution of the "Adrenochrome" mythos from historical blood libel to modern extremist propaganda.
**Objective:** Map the Venn diagram between occultism, neo-Nazism, and modern Q-adjacent narratives.
...
- Keywords: `Adrenochrom`, `Blutkult`, `Reichsbürger`, `Neo-Nazismus`, `Kinderhandel` (in context of extremist claims).
